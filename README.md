...
This project includes fonts licensed under the SIL Open Font License 1.1:

- **AdwaitaSans-Regular** by Gnome
  - License: SIL Open Font License 1.1
  - License file: [fonts/AdwaitaSans/LICENSE](fonts/AdwaitaSans/LICENSE)
  - Source: https://gitlab.gnome.org/GNOME/adwaita-fonts/

- **AdwaitaMono-Regular** by Gnome
  - License: SIL Open Font License 1.1
...
- **OCR-B** by Adrian Frutiger
  ...
  - Source: https://fontesk.com/ocr-b-font/

The font files are located in the `fonts/` directory and are subject to their respective licenses.
